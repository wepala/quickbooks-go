...
func (c *Client) Create(
	ctx context.Context,
	companyid string,
	request *api.DepositCreateRequest,
	...
	endpointURL := core.EncodeURL(baseURL+"/v3/company/%v/deposit", companyid)
...
func (c *Client) Readbyid(
	ctx context.Context,
	companyid string,
	request *api.DepositReadbyidRequest,
	opts ...option.RequestOption,
) error {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(baseURL+"/v3/company/%v/deposit/162", companyid)
