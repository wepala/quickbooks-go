...
func (c *Client) Create(
	ctx context.Context,
	companyid string,
	request *api.BillpaymentCreateRequest,
	...
	endpointURL := core.EncodeURL(baseURL+"/v3/company/%v/billpayment", companyid)
...
func (c *Client) Readbyid(
	ctx context.Context,
	companyid string,
	request *api.BillpaymentReadbyidRequest,
	opts ...option.RequestOption,
) error {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(baseURL+"/v3/company/%v/billpayment/118", companyid)
