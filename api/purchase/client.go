...
func (c *Client) Create(
	ctx context.Context,
	companyid string,
	request *api.PurchaseCreateRequest,
	...
	endpointURL := core.EncodeURL(baseURL+"/v3/company/%v/purchase", companyid)
...
func (c *Client) Readbyid(
	ctx context.Context,
	companyid string,
	request *api.PurchaseReadbyidRequest,
	opts ...option.RequestOption,
) error {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(baseURL+"/v3/company/%v/purchase/175", companyid)
