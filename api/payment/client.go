...
func (c *Client) Create(
	ctx context.Context,
	companyid string,
	request *api.PaymentCreateRequest,
	...
	endpointURL := core.EncodeURL(baseURL+"/v3/company/%v/payment", companyid)
...
func (c *Client) Readbyid(
	ctx context.Context,
	companyid string,
	request *api.PaymentReadbyidRequest,
	opts ...option.RequestOption,
) error {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(baseURL+"/v3/company/%v/payment/174", companyid)
